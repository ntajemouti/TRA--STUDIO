  ...
  return (
    <div className="w-full space-y-8 sm:space-y-10 animate-in fade-in duration-300 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-2 text-left">
        ...
        <ScrollReveal animation="fade-up" delay={0} duration={650} className="h-full">
          <div className="relative rounded-3xl bg-zinc-900/80 border-2 border-studio-red p-7 sm:p-8 flex flex-col justify-between space-y-6 shadow-2xl shadow-studio-red/20 transform lg:-translate-y-2 h-full">
            {/* Top Badge */}
        ...
        <ScrollReveal animation="fade-up" delay={120} duration={650} className="h-full">
          <div className="rounded-3xl bg-zinc-900/60 border border-zinc-800 p-7 sm:p-8 flex flex-col justify-between space-y-6 shadow-xl hover:border-zinc-700 transition-all h-full">
            <div className="space-y-4">
              <div className="space-y-1">
                <h3 className="text-2xl font-black text-white uppercase tracking-tight">
                  Tournage Seul
        ...
        <ScrollReveal animation="fade-up" delay={240} duration={650} className="h-full">
          <div className="rounded-3xl bg-zinc-900/60 border border-zinc-800 p-7 sm:p-8 flex flex-col justify-between space-y-6 shadow-xl hover:border-zinc-700 transition-all h-full">
            <div className="space-y-4">
              <div className="space-y-1">
                <h3 className="text-2xl font-black text-white uppercase tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {packages
            ...
            .map((pkg, idx) => {
              ...
              return (
                <ScrollReveal key={pkg.id} animation="fade-up" delay={idx * 80} duration={600} className="h-full">
                  <div
                    onClick={() => handleOpenDetail(pkg)}
                    className={`group relative rounded-2xl bg-studio-card border transition-all duration-300 p-5 flex flex-col justify-between space-y-4 cursor-pointer hover:scale-[1.01] h-full ${
                      isSelected
      ...
      <ScrollReveal animation="fade-up" delay={100} duration={650} className="pt-6">
