        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          {INSTAGRAM_POSTS.map((post) => (
            <div
              ...
              className="group relative rounded-2xl bg-zinc-900/80 border border-zinc-800/90 hover:border-pink-500/50 overflow-hidden shadow-xl hover:shadow-2xl hover:shadow-pink-500/10 transition-all duration-300 flex flex-col cursor-pointer text-left hover:-translate-y-1"
            >
              ...
              {/* Post Caption Footer */}
              <div className="p-4 bg-zinc-900/40 space-y-2">
